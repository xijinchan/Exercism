...
namespace queen_attack {
    chess_board::chess_board(std::pair<int, int> white_new, std::pair<int, int> black_new) {
        if (white_new.first < 0 or white_new.first > 7 or
            white_new.second < 0 or white_new.second > 7 or
            black_new.first < 0 or black_new.first > 7 or
            black_new.second < 0 or black_new.second > 7 or
            white_new == black_new)
        {
