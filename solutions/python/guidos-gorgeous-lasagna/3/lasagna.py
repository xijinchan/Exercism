...
def bake_time_remaining(elapsed_bake_time):
    ...
    bake_time_remaining_local = EXPECTED_BAKE_TIME - elapsed_bake_time
    return bake_time_remaining_local
...
def elapsed_time_in_minutes(number_of_layers, elapsed_bake_time):
    ...
    elapsed_time_in_minutes_local = elapsed_prep_time + elapsed_bake_time
    return elapsed_time_in_minutes_local
