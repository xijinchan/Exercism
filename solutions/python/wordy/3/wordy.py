def answer(question):
    ...
    error = False
    for i in range(0,len(question_split)): # error if numbers in a row / missing operators
        try:
    ...
    try:        
        ...
        for i in range(0,len(question_split)):
            ...
            if no_of_numbers > 0 and no_of_numbers % 2 == 0: # evaluate left to right linearly (ie. ignore PEMDAS / BODMAS...)
